...
/** A type alias, not an interface, on purpose: supabase-js requires every Row
 *  to be assignable to Record<string, unknown>, which interfaces are not. One
 *  non-conforming table makes the whole schema fall through and every table's
 *  rows type as `never`. */
...
export interface Database {
  public: {
    Tables: {
      ...
      // `id` and `created_at` are generated by Postgres.
      analytics_events: TableConfig<
        AnalyticsEventRow,
