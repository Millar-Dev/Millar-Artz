...
export const SETTING_KEYS = [
  ...
  "payment_lipa_name",
  "paypal_name",
  /** Optional PayPal.me (or similar) link; the name is shown either way. */
  "paypal_link",
  "email",
  "phone_primary",
  "phone_secondary",
...
export const SETTING_DEFAULTS: SiteSettings = {
  ...
  tiktok_url: "",
  youtube_url: "",
  // The number buyers message from "Buy this piece" (2026-09-19).
  whatsapp_number: "255793730227",
  payment_mobile: "+255 793 730 227",
  payment_lipa_bank: "Equity Bank",
  payment_lipa_namba: "80025069",
